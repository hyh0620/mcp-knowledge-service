...
def generate_complex_pdf(output_path):
    ...
    The recursive character text splitter is the default choice, providing a useful 
    ...
    future_text = """
    This fixture closes with a neutral maintenance section. It describes how
    retrieval fixtures can remain stable over time through clear source
    citations, deterministic expected outputs, and small regression datasets.
    """
