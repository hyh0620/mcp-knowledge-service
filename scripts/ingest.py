#!/usr/bin/env python
"""Ingestion script for the MCP Knowledge Service.
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Ingest documents into the MCP Knowledge Service knowledge hub.",
    ...
    parser.add_argument(
        ...
        help="Collection name for organizing documents (default: 'knowledge_hub')"
    )
